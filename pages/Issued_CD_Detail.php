...
$issue_info = $engine->get_CD_issue_by_($book_id);
$User_Info = $engine->get_student($user_id);
$The_CD = $engine->get_CDs($book_id);
        ...
        <div class="col-md-12 col-lg-12" style="margin-left: 5px" >
            <form class="form-horizontal"  method="post" action="">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3" >
                    ...
                    <label class="form-control" for="book_title"><?php echo $engine->get_book_cat_name($The_CD['cat_id'])['name']?> </label>
                </div>
                <div class="col-sm-3 col-md-3 col-lg-3" style=" margin-left: 5px; padding-bottom: 20px">
                    ...
                    <label class="form-control" for="book_title"><?php echo $The_CD['call_number']?> </label>

                    <label class="label label-info">CD-DVD Copy Number: </label>
                    <label class="form-control" for="book_title"><?php echo $The_CD['copy_number']?> </label>
