...
<div class="container" id="main">
    ...
    <hr>
    <label class="form-control">Librarians</label>
    <hr>
    <div  class="row" id="contact">
        ...
        <div class="col-md-3 col-lg-3" style="margin-left: 50px" >
            <form class="form-vertical" role="form" method="post" action="">
                ...
                <button class="btn btn-primary btn-lg"  name="Add_New_Librarian" id="Add_New_Librarian" type="submit"><strong> Register </strong> </button>
            </form>
        </div>
    </div>
    <div class="row">
