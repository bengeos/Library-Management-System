        ...
        <div class="col-lg-9">
            ...
            <div class="table-responsive ">
                <table class="table table-bordered">
                    ...
                    $engine = new LMS_Engine();
//                    if(isset($_POST['Search_Items'])) {
                        $founds = $engine->search_cds_not_issued($hint, $from, $cat_id);
//                    }else {
//                        $founds = $engine->search_cds_not_issued(null, null, 0);
//                    }
                    $total = count($founds);
                    $size = 10;
                    $start = $page_num * $size;
                    ...
                    if($start > $i)
                    {
                        ...
                        include 'pages/elements/Search_CDs_Table_Items.php';
                        $disp++;
                        $i++;
                    }else{
                        break;
            ...
            <div class="table table-responsive">
                <div class="well">
                    <form action="?page=search_cd_dvd" method="get" id="pagination">
                        <input type="hidden" name="page" value="search_cd_dvd">
